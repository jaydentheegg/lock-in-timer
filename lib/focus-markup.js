...
<main class="focus-page" aria-label="Timer" data-phase="link" data-started="false" data-running="false" data-sound="on" data-burst="none">
  <video class="focus-video" poster="./study-poster.jpg" loop muted playsinline preload="metadata"><source src="./study-loop.av1.mp4" type="video/mp4; codecs=av01.0.05M.08"><source src="./study-loop.mp4" type="video/mp4; codecs=avc1.640028"><track kind="captions" src="./empty-captions.vtt" srclang="zh" label="无对白" default></video>
